package com.rupeeroute.notification_service.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ExpenseEvent> consumerFactory() {
        ...
        // Ignore type headers — deserialize as our own ExpenseEvent
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        config.put(JsonDeserializer.USE_TYPE_INFO_HEADERS, false);
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE,
                "com.rupeeroute.notification_service.dto.ExpenseEvent");
